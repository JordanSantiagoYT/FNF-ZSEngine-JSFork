...
class OutdatedSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		warnText = new FlxText(0, 0, FlxG.width,
			'Looks like you\'re running an outdated version of\nZS Engine (${MainMenuState.zsEngineVersion})\n
			-----------------------------------------------\n
	...
	override function update(elapsed:Float)
	{
		if(!leftState) {
			if (controls.ACCEPT) {
				leftState = true;
				CoolUtil.browserLoad("https://github.com/SuperHero2010/FNF-ZSEngine/releases");
			}
